...
extension ArchiveCoordinator: Coordinator {
    func start() {
        self.startCatalog()
    }
}

private extension ArchiveCoordinator {
    func startCatalog(_ completion: (() -> Void)? = nil) {
        ...
        let presenter = CatalogPresenter(view: view,
                                         ...
                                         catalogAPIService: apiService, archiveAPIService: self.archiveAPIService, viewMode: .archive)
...
extension ArchiveCoordinator: Observer {

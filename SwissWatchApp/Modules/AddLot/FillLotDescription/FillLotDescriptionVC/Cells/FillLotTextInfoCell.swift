...
class FillLotTextInfoCell: MagazineLayoutCollectionViewCell {
    ...
    func setupCell() {
        ...
        NotificationCenter.default
            ...
            .map({($0.object as! UITextField).text}).map({($0 == nil || ($0?.isEmpty ?? true)) ? Colors.grayTextColor : Colors.cyanColor})
...
fileprivate extension FillLotTextInfoCell {
